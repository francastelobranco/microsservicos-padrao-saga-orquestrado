...
public class KafkaConfig {
    ...
    public NewTopic paymentSuccessTopic() {
        return buildTopic(PAYMENT_VALIDATION_SUCESS.getTopic());
    }

    @Bean
    public NewTopic paymentFailTopic() {
        return buildTopic(PAYMENT_VALIDATION_FAILED.getTopic());
    }

    @Bean
    public NewTopic inventorySucessTopic() {
        return buildTopic(INVENTORY_VALIDATION_SUCESS.getTopic());
    }

    @Bean
    public NewTopic inventoryFailTopic() {
        return buildTopic(INVENTORY_VALIDATION_FAILED.getTopic());
    }
}
